...
export const defaultMetadata = {
  ...
  description:
    "أهلاً بكم في ايثاق ماركت، وجهتكم الأمثل للتسوق الإلكتروني! نحن وجهتكم الشاملة لمجموعة متنوعة من المنتجات، جميعها مختارة بعناية من بائعين موثوقين.",
  keywords: metaKeywords.join(", "),
  creator: "SM Tanimur Rahman",
  publisher: "SM Tanimur Rahman",
  applicationName: "ايثاق ماركت",
  ...
  openGraph: {
    ...
    locale: "en_US",
    url: baseURL,
    siteName: "ايثاق ماركت",
    title: "ايثاق ماركت - سوبر ماركت",
    description:
